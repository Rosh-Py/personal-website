...
![Janky UX demo](https://cdn.hashnode.com/uploads/covers/69aa683cb8d41e6ded0d16fb/696691dd-cdb4-4720-8dab-4a374938409c.gif)
...
Let's tackle the problem with the help of `requestIdleCallback` ([read more](https://developer.mozilla.org/en-US/docs/Web/API/Window/requestIdleCallback)). It accepts a callback and passes `deadline` as first argument to the callback. `deadline` exposes a method called `remainingTime` which returns the estimated browser idle time remaining. We can make use of these details to schedule our task during the idle period.

![Browser idle period lifecycle](https://cdn.hashnode.com/uploads/covers/69aa683cb8d41e6ded0d16fb/a95c347d-97a7-47a5-bbd2-a8294244a872.png)

In the above image **rAF** stands for `requestAnimationFrame` ([read more](https://developer.mozilla.org/en-US/docs/Web/API/Window/requestAnimationFrame)) which is used to schedule high priority task, unlike `requestIdleCallback` which is used to schedule low priority tasks.
...
![Smooth UX with requestIdleCallback](https://cdn.hashnode.com/uploads/covers/69aa683cb8d41e6ded0d16fb/1c3ec03f-8258-4229-a75a-bddb897a669a.gif)
