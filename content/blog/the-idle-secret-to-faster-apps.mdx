...
canonicalUrl: "https://jroshan.hashnode.dev/the-idle-secret-to-faster-apps"
---

import jankyUxDemo from '@/public/blog/janky-ux-demo.webp';
import browserIdlePeriodLifecycle from '@/public/blog/browser-idle-period-lifecycle.webp';
import smoothUxIdleCallback from '@/public/blog/smooth-ux-idle-callback.webp';
