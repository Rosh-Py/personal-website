...
tags:
  ...
  - state-management
featured: true
coverImage: "/blog/redux-flow.webp"
canonicalUrl: "https://jroshan.hashnode.dev/under-the-hood-of-redux-create-a-lightweight-state-manager"
---

import reduxFlow from '@/public/blog/redux-flow.webp';
...
<Image src={reduxFlow} placeholder="blur" alt="Redux Unidirectional data flow" width={1600} height={840} />
